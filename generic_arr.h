...
#define LIST_DEFINE(type)                                                                                            \
	...
	{                                                                                                                \
		...
		{                                                                                                            \
			if (idx < 0)                                                                                             \
			{                                                                                                        \
				fprintf(stderr, "Attempting to write to invalid index before allocated memory.\n");                  \
				exit(-1);                                                                                            \
			}                                                                                                        \
			else if ((size_t)idx >= ls->sz)                                                                          \
			{                                                                                                        \
				fprintf(stderr, "Attempting to write to invalid index after allocated memory.\n");                   \
			}                                                                                                        \
		}                                                                                                            \
		else if (!_writemode)                                                                                        \
		{                                                                                                            \
			if (idx < 0)                                                                                             \
			{                                                                                                        \
				fprintf(stdout, "WARNING: Reading from invalid index before allocated memory.\n");                   \
			}                                                                                                        \
			else if ((size_t)idx >= ls->sz)                                                                          \
			{                                                                                                        \
				fprintf(stdout, "WARNING: Reading from invalid index after allocated memory.\n");                    \
			}                                                                                                        \
		}                                                                                                            \
		return true;                                                                                                 \
	}                                                                                                                \
	...
	{                                                                                                                \
		...
		{                                                                                                            \
			...
			exit(-1);                                                                                                \
                                                                                                                     ...
                                                                                                                     \
		if (validate_##type##_idx(ls, start_idx, false) && validate_##type##_idx(ls, end_idx, false))                \
		{                                                                                                            \
			if (end_idx < ls->sz)                                                                                    \
			{                                                                                                        \
